document.addEventListener('DOMContentLoaded', function () {
  ...
  const ANIMATION_SELECTORS = '.animate-on-scroll, .fade-in, .scroll-animate, [data-animate]';
  ...
  animationStyles.textContent = [
    ...
    '@media(prefers-reduced-motion:reduce){.' + ANIMATION_CLASS + '{transition:none;transform:none;opacity:1;}}'
  ].join('');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Solo משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd6d5f72d-68bc-4825-98e0-c28ef64510da',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd6d5f72d-68bc-4825-98e0-c28ef64510da';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd6d5f72d-68bc-4825-98e0-c28ef64510da';
